...
public interface TransactionService {
    void createAndSave(Map<Product, Integer> products, Customer customer, User user);
    List<Transaction> getTransaction(Map<Product, Integer> products, Customer customer, User user);
